    ...
    events: {
      bride: {
        ...
        event: {
          ...
          mapEmbedUrl: "https://www.google.com/maps?q=13.8889284,109.1379013&z=17&output=embed",
          mapsVerified: true,
          venueStatusNote: "",
          landmarkNote: "",
          entranceNote: "",
      ...
      nhatrang: {
        ...
        event: {
          ...
          venueName: "Sảnh Sea Flower, Khách sạn Xavia",
          addressLine1: "09 Hoàng Diệu",
      ...
      saigon: {
        ...
        event: {
          ...
          timeline: [
            ...
            { time: "19h00", datetime: "2026-08-22T19:00:00+07:00", label: "Bắt đầu Tiệc Báo Hỷ", note: "Kính mời Quý khách cùng chung vui trong buổi tiệc thân mật." }
          ],
