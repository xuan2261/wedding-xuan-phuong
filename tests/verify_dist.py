...
if 'v19.4-20260724' not in index: errors.append('dist sai build')
...
for event_id in ['bride','groom','nhatrang','saigon']:
    ...
    if not page.exists(): errors.append(f'dist thiếu share page {event_id}')
    elif f'data-event-id="{event_id}"' not in page.read_text(encoding='utf-8'): errors.append(f'share page sai event {event_id}')
